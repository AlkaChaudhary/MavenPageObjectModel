...
public class LoginSearchAddCartChkOutTest {
	...
	Assert.assertTrue(mp.accountBread().isDisplayed());	
	...
	Assert.assertTrue(sop.breadcrumbSucessField().isDisplayed());
	String expectedsucessmsg1="Your order has been placed!";
	String actualsucessmsg1=sop.chkOutSucessMsgField().getText();
	Assert.assertEquals(actualsucessmsg1, expectedsucessmsg1);
